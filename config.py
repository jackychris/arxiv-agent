...
PORT_ACADEMIC_MCP = _int_env("PORT_ACADEMIC_MCP", _int_env("PORT_MCP", 8765))
...
ACADEMIC_MCP_HOST = os.getenv("ACADEMIC_MCP_HOST", os.getenv("ARXIV_MCP_HOST", "127.0.0.1"))
...
ACADEMIC_MCP_URL = os.getenv(
    "ACADEMIC_MCP_URL",
    os.getenv("ARXIV_MCP_URL", f"http://{ACADEMIC_MCP_HOST}:{PORT_ACADEMIC_MCP}/mcp"),
)
...
MCP_TOOL_RETRY_ATTEMPTS = _int_env("MCP_TOOL_RETRY_ATTEMPTS", 3)
MCP_TOOL_RETRY_BACKOFF_SECONDS = _float_env("MCP_TOOL_RETRY_BACKOFF_SECONDS", 2.0)
MCP_ARXIV_MIN_INTERVAL_SECONDS = max(_float_env("MCP_ARXIV_MIN_INTERVAL_SECONDS", 5.0), 5.0)
